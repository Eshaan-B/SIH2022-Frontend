              ...
              <div className="col-lg-7">
                ...
                <div className="tab-content">
                  ...
                  <div className="tab-pane fade show" id="tab2">
                    <div className="d-flex align-items-center mt-4">
                      <i className="bi bi-check2" />
                      <h4><a href="https://universitygames.kheloindia.gov.in/">1st Khelo India University Games, Odisha - 2020</a></h4>
                    </div>
                    <div className="d-flex align-items-center mt-4">
                      <i className="bi bi-check2" />
                      <h4><a href="https://youthgames.kheloindia.gov.in/">Khelo India Youth Games, Pune, Maharashtra</a></h4>
                    </div>
                    <div className="d-flex align-items-center mt-4">
                      <i className="bi bi-check2" />
                      <h4><a href="https://schoolgames.kheloindia.gov.in/">Khelo India School Games, Delhi-2018</a></h4>
                    </div>
